...
|---|---|---:|---|---|---:|---:|---|
| 紫微 | L1_INDEXED | 148 | PASS | READY_FOR_EXTRACTION | 0 | 0 | K2_SOURCE_LINEAGE |
| 八字 | L1_INDEXED | 168 | PASS | READY_FOR_EXTRACTION | 0 | 0 | K2_SOURCE_LINEAGE |
| 奇门 | L1_INDEXED | 154 | PASS | READY_FOR_EXTRACTION | 0 | 0 | K2_SOURCE_LINEAGE |
| 六爻 | L1_INDEXED | 7 | PASS | THIN_CORPUS | 0 | 0 | K2_SOURCE_LINEAGE |
| 大六壬 | L1_INDEXED | 10 | PASS | THIN_CORPUS | 0 | 0 | K2_SOURCE_LINEAGE |
| 风水 | L1_INDEXED | 28 | PASS | READING_REQUIRED | 0 | 0 | K2_SOURCE_LINEAGE |
