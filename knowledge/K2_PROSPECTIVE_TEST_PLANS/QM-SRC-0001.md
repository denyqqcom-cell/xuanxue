...
1. Build source-faithful fixture extraction for the 18 bureau tables.
2. Add explicit context fields from the Method Delta to experimental case records.
3. Design Test A and Test F first because they target setup integrity and degrees of freedom before interpretive accuracy.
4. Only then run deity/star/hour-omen comparisons.
5. Keep ritual and gambling material outside operational scoring.
