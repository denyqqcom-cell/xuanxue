...
import audit_qm0017_day_jielukongwang_consistency as audit

ROOT=Path(__file__).resolve().parents[1]
FIXTURE=ROOT/"knowledge"/"K2_SOURCE_INTERNAL_CONSISTENCY_FIXTURES"/"QM0017_DAY_JIELUKONGWANG_RULE_EXAMPLES_V1.json"
...
def main():
    ...
    assert report["matching_cases"]==12
    ...
    assert report["interpretation_status"]=="SOURCE_INTERNAL_TENSION"
    ...
    print("qm0017-day-jielukongwang-consistency: PASS")
    print("cases=13 matching=12 mismatches=1 status=SOURCE_INTERNAL_TENSION resolution=CONTEXT_REQUIRED empirical_credit=NONE")
