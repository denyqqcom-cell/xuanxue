...
import audit_qm0017_day_xishen_consistency as audit

ROOT=Path(__file__).resolve().parents[1]
FIXTURE=ROOT/"knowledge"/"K2_SOURCE_INTERNAL_CONSISTENCY_FIXTURES"/"QM0017_DAY_XISHEN_RULE_EXAMPLES_V1.json"
...
def main():
    ...
    assert report["mismatches"]==data["expected_mismatches"]
    ...
    print("qm0017-day-xishen-consistency: PASS")
