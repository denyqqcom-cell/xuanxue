...
def main():
    sources={
      "A":{"source_id":"A","knowledge_domains":["ziwei"],"pages":10},
      "B":{"source_id":"B","knowledge_domains":["ziwei"],"pages":20},
      "C":{"source_id":"C","knowledge_domains":["liuyao"],"pages":30},
      "D":{"source_id":"D","knowledge_domains":["UNKNOWN"],"pages":40},
    }
    lineage={
