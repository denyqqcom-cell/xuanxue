...
EXPECTED_BLOBS = {
    ...
    "production_profile_test_git_blob": "642a1556b148e2009144f3e0884460bca523ef70",
}
...
def main():
    ...
    require(proto.get("shared_profiles", {}).get("abstention_metric_value") == 0.0, "protocol abstention profile drift")
    ...
    print(
        "k2-qimen-p2-production-profile-validator: PASS "
        ...
        "complexity_total=15 abstain_metric=0.0 "
