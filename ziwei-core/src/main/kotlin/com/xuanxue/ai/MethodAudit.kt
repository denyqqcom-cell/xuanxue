...
object MethodAuditRegistry {
    ...
    val qimen = MethodAudit(
        ...
        summary = "资料交接与当前 K2 审计已把日时干支、旬首旬空、五不遇时、击刑、部分定局规则和局部 source-grounded dated fixtures 工程化；weather-v0.1 的 CHAI_BU_FUTOU method vector 已完成来源组件与独立天文交节边界核验，但完整九宫全局黄金盘、第二张独立 dated plate 与现实预测有效性仍未关闭。",
        verified = listOf(
            ...
            "QM-SRC-0021 的 2004-05-29 chart-only anchor 已直接核对九星与 Gong.tianGan pairing，但仍只有一张来源 dated plate",
        ),
        limitations = listOf(
